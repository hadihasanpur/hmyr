...
<ul class="d-flex justify-content-center">
    ...
    <li>
        <a class="prev" href="{{ $paginator->previousPageUrl() }}" rel="prev"
            aria-label="@lang('pagination.previous')"><i class="sli sli-arrow-left"></i></a>
    </li>
    @endif
    ...
    @if ($paginator->hasMorePages())
    <li>
        <a class="next" href="{{ $paginator->nextPageUrl() }}" rel="next" aria-label="@lang('pagination.next')"><i
                class="sli sli-arrow-right"></i></a>
    </li>
    @else
