            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-3">
                    ...
                    <select class="form-control" id="parent_id" name="parent_id">
                        ...
                        <option value="{{ $parentCategory->id }}" {{ $category->parent_id == $parentCategory->id ?
                            'selected' : '' }}
                            >
                            {{ $parentCategory->name }}
                        </option>
                ...
                <div class="form-group col-md-3">
                    ...
                    <select id="attributeSelect" name="attribute_ids[]" class="form-control" multiple
                        ...
                        <option value="{{ $attribute->id }}" {{ in_array($attribute->id ,
                            $category->attributes()->pluck('id')->toArray()) ? 'selected' : '' }}
