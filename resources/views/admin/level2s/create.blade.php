...
<div class="row">
    <div class="p-4 mb-4 bg-white col-xl-12 col-md-12">
        ...
        <form action="{{ route('admin.level2s.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div>
                <div class="form-row">
                ...
                <div class="row">
                    <div class="form-gro‍up col-md-3">
                        <label for="tel1">شماره دفتر </label>
            ...
            <a href="{{ route('admin.level2s.index') }}" class="mt-3 btn btn-dark">بازگشت</a>
        </form>
    </div>
</div>
@endsection