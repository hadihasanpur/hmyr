<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 der-gray-100 darborder-b">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link class="font-bold dark:text-gray-200" href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
                        {{ __('Dashboard') }}
                    </x-jet-nav-link>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link class="dark:text-gray-200" href="{{ route('posts.index') }}"
                        :active="request()->routeIs('posts.index')">
                        {{ __('Posts') }}
                    </x-jet-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link class="dark:text-gray-200" href="{{ route('welcome') }}" :active="request()->routeIs('welcom/')">
                        {{ __('hmyr.r') }}
                    </x-jet-nav-link>
                </div>
            </div>
